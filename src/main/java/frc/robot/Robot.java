...
public class Robot extends TimedRobot {
  ...
  public Jaguar LeftFront;
  public Jaguar RightFront;
  public Jaguar LeftBack;
  public Jaguar RightBack;
  public XboxController xcontroller;
  public AHRS RoboGyro; 
  public CameraServer RoboCam;
  public UsbCamera FrontCamera;
  public UsbCamera BackCamera;
  public DigitalInput switch0;
  ...
  public void robotInit() {
    ...
    LeftFront = new Jaguar(2);
    RightFront = new Jaguar(3);
    LeftBack = new Jaguar(0);
    RightBack = new Jaguar(1);
    ...
    try {
			 ...
			 ************************************************************************/
            RoboGyro = new AHRS(SPI.Port.kMXP); 
